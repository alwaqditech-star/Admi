...
import 'admin_regesr_model.dart';
export 'admin_regesr_model.dart';

class AdminRegesrWidget extends StatefulWidget {
  ...
  @override
  State<AdminRegesrWidget> createState() => _AdminRegesrWidgetState();
}

class _AdminRegesrWidgetState extends State<AdminRegesrWidget> {
  late AdminRegesrModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AdminRegesrModel());
  ...
  try {
    ...
    final userCredential = await FirebaseAuth.instance
      ...
      password: _model.passTextController.text.trim(),
    );
